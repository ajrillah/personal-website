...
// const TechstackCard = ({ imgSrc, title, desc, tags }) => {
//   return (
...
const TechstackCard = ({ name, type, icon }) => {
  return (
    <div className="group bg-zinc-50/5 hover:bg-zinc-50/10 hover:-translate-y-1 transition-all rounded-xl p-4 flex flex-col items-center gap-3 text-center">
      <span className="text-3xl text-zinc-300 group-hover:scale-110 transition-transform">
        {icon}
      </span>
      <div>
